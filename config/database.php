    ...
    */
    ...
    'connections' => [
        ...
        'operasional' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DBO_HOST', '127.0.0.1'),
            'port' => env('DBO_PORT', '3306'),
            'database' => env('DBO_DATABASE', 'forge'),
            'username' => env('DBO_USERNAME', 'forge'),
            'password' => env('DBO_PASSWORD', ''),
            'unix_socket' => env('DBO_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
